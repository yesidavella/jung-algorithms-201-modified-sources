...
//            System.out.print(v+",");
            ...
            TreeMap<String, E> orderedEdges = new TreeMap<String , E>(); 
            //Order the edges over a vertex by his name
            for (E e : getEdgesToCheck(v) ) {
                orderedEdges.put(e.toString(), e); 
            }
            
            for (String key: orderedEdges.keySet() ) {
                
                E e  = orderedEdges.get(key); 
